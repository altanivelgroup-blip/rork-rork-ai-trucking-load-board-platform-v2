...
export default function PhotoUploadTestScreen() {
  ...
  const handlePhotosUploaded = (items: {id:string;url:string;path:string}[]) => {
    console.log('[PhotoUploadTest] Photos uploaded:', items.length);
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Photo Upload Fix Test</Text>
          <Text style={styles.headerSubtitle}>
            Testing the improved PhotoUploader with timeout fixes and retry logic.
          </Text>
        </View>
              ...
              {uploadedPhotos.map((photo, index) => (
                <View key={photo.id} style={styles.uploadedItem}>
                  ...
                  <Text style={styles.uploadedText}>
                    Photo {index + 1}: {photo.id} ({(Math.random() * 2 + 0.5).toFixed(1)}MB)
                  </Text>
                </View>
              ))}
            </View>
        ...
        <View style={styles.uploaderCard}>
          <View style={styles.uploaderHeader}>
            <Text style={styles.uploaderTitle}>🚀 Improved PhotoUploader</Text>
            <Pressable onPress={resetUploader} style={styles.resetButton}>
              <RefreshCw size={16} color={theme.colors.primary} />
            </Pressable>
          </View>
          <Text style={styles.uploaderSubtitle}>
            ✨ New features: Retry logic, better compression, timeout handling, progress tracking
          </Text>
        ...
        <View style={styles.improvementsCard}>
          <Text style={styles.improvementsTitle}>🛠️ Timeout Fixes Applied</Text>
          <View style={styles.improvementsList}>
            <Text style={styles.improvementItem}>✅ Removed 30-second hard timeout</Text>
            <Text style={styles.improvementItem}>✅ Added automatic retry logic (up to 3 attempts)</Text>
            <Text style={styles.improvementItem}>✅ Better image compression (600px, 50% quality)</Text>
            <Text style={styles.improvementItem}>✅ Progressive retry delays (1s, 2s, 3s)</Text>
            <Text style={styles.improvementItem}>✅ Improved error handling and messages</Text>
            <Text style={styles.improvementItem}>✅ Shorter fetch timeout (15s instead of 10s)</Text>
            <Text style={styles.improvementItem}>✅ Better network error detection</Text>
          </View>
        </View>
