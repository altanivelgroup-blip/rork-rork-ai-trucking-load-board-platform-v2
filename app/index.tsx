...
export default function Index() {
  ...
  console.log('[Index] 🎯 SIGN IN NAVIGATION - Auth state:', {
  ...
  console.log('[Index] 🎯 SIGN IN NAVIGATION - User authenticated, redirecting to dashboard based on role:', user.role);
